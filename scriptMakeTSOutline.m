...
for image=[12:16]
mRNAResult=fullfile(resultDir,'Results\ExSL\', ['C1-ExSL_' num2str(image) '__outline_spots_201217.txt']);
...
proteinOutline=fullfile(resultDir,'Outlines\', ['C3-ExSL_' num2str(image) '__outline.txt']);
...
proteinOutlineTS=fullfile(resultDir,'Outlines\', ['C3-ExSL_' num2str(image) '_TS_outline.txt']);
